...
const StatusPage = () => {
  ...
  const elements = [(<DataElement key="element_1" command="app-version" interval = {0}></DataElement>),(<DataElement key="element_2" command="meshctl-version" interval = {0}></DataElement>),(<ListElemenet key="element_3" command="list-adapters" interval = {0}></ListElemenet>),(<RegularButton key="element_4" command='reset-meshctl-config' text='Request' style='btn bg-transparent w-full'></RegularButton>)]
